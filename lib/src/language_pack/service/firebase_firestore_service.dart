...
final class FirebaseFirestoreService extends DatabaseService {
  ...
  @override
  Future<Result<Map<String, dynamic>>> getRow({required String table,
    ...
    final documentSnapshot = await firestoreInstance
      ...
      if (!documentSnapshot.exists) {
        final errorMessage = 'No document found with id $id in collection $table';
  ...
  @override
  Future<Result<void>> update({required String table,
    required String id,
  ...
  @override
  Future<Result<void>> insert({required String table,
    required String id,
